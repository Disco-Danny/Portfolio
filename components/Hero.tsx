        ...
        <div>
            ...
            <div className='flex justify-center relative my-20 z-10'>
                <div className='max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center'>
                    <h2 className='uppercase tracking-widest text-2xl text-center text-blue-200 max-w-80'>
                        A Chill Guy
                    </h2>
                    <TextGenerateEffect 
                    className='text-center text-[50px] md: text-5xl lg:text-6xl'
                    words='I can be the Best Investment your Company will Ever Make'/>

                    <p className='text-center  md:tracking-wider mb-4 text-sm md:text-lg lg:text-2xl'>
                        Hi, I&apos;m Daniyaal - a Frontend Developer, a Power BI Analyst, a Machine Learning Aficionado, a UI/UX Designer, a Product Manager, and an Amazing Cook.
                    </p>
