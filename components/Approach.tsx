  ...
  return (
    <section className="w-full py-20">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center  gap-4 ">
        ...
        />}
        description='This is how I think/act in Phase 1'>
          <CanvasRevealEffect
            animationSpeed={5.1}
            containerClassName="bg-emerald-900"
          />
        </Card>
        <Card title="Protoyping/Wireframing"
        icon={<AceternityIcon order="Phase 2"/>}
        description='This is how I think/act in Phase 2'>
          <CanvasRevealEffect
            animationSpeed={3}
        ...
        <Card title="Bug Fixes and Further Improvements " icon={<AceternityIcon order="Phase 3"/>}
        description='This is how I think/act in Phase 3'>
          <CanvasRevealEffect
            animationSpeed={3}
...
const AceternityIcon = ({order}: {order: string}) => {
  return (
   <div>
    <button className="px-8 py-0.5  border-2 border-black dark:border-white uppercase bg-black-200 text-white transition duration-200 text-sm shadow-[1px_1px_rgba(0,0,0),2px_2px_rgba(0,0,0),3px_3px_rgba(0,0,0),4px_4px_rgba(0,0,0),5px_5px_0px_0px_rgba(0,0,0)] dark:shadow-[1px_1px_rgba(255,255,255),2px_2px_rgba(255,255,255),3px_3px_rgba(255,255,255),4px_4px_rgba(255,255,255),5px_5px_0px_0px_rgba(255,255,255)] ">
